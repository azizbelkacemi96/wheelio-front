...
/**
 * Accessible radiogroup primitive (correct a11y role for a mutually
 * exclusive one-of-two/one-of-many choice — never a pair of buttons with
 * aria-pressed). Hand-authored from the unified `radix-ui` package to match
 * how every other shared/ui primitive is built (select.tsx, button.tsx).
 */
function RadioGroup({
  className,
  ...props
